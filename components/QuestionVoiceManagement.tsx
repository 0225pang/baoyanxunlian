  ...
  return <section className="voice-management">
    ...
    <details className="voice-service-details">
      ...
      <section className="voice-settings-card"><div className="voice-settings-grid">
        ...
        <label className="wide">Sambert Workspace WebSocket（官方 Java SDK）<input value={settings.sambertWebsocketUrl} onChange={(event) => setSettings({ ...settings, sambertWebsocketUrl: event.target.value })} placeholder="wss://{WorkspaceId}.cn-beijing.maas.aliyuncs.com/api-ws/v1/inference" /></label>
